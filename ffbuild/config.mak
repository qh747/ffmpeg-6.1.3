...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/quhan/01_myProject/ffmpeg-6.1.3/install --enable-debug --enable-static --enable-ffplay --enable-ffprobe --enable-libvorbis --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libmp3lame --enable-libvpx --enable-libopus --enable-libxvid --enable-libx264 --enable-libx265 --enable-openal --enable-openssl --enable-libaom --enable-libfdk-aac --enable-libass --enable-nonfree --enable-libtheora --enable-gpl --enable-version3 --enable-libvo-amrwbenc
...
CC_IDENT=gcc 13 (Ubuntu 13.1.0-8ubuntu1~22.04)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC    -pthread   -I/usr/include/uuid -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/fribidi -I/usr/include/freetype2 -I/usr/include/libpng16  -I/usr/include/opus -I/usr/include/opus   -I/usr/local/include -I/usr/local/include -I/usr/local/include -I/usr/local/include -DX264_API_IMPORTS  -I/usr/include/AL           -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -D_REENTRANT -I/usr/include/SDL2
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -lopenal -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes -lasound -lSDL2 -lsndio -lXv -lX11 -lXext
EXTRALIBS-avfilter=-pthread -lm -latomic -lass -lva
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz -lssl -lcrypto
EXTRALIBS-avcodec=-L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -L/usr/local/lib -lvpx -lm -pthread -lm -latomic -llzma -lopencore-amrwb -laom -lfdk-aac -lmp3lame -lm -lopencore-amrnb -lopus -ltheoraenc -ltheoradec -logg -lvo-amrwbenc -lvorbis -lvorbisenc -lx264 -lx265 -lxvidcore -lz -lva
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lva-drm -lva -lva-x11 -lva -lvdpau -lX11 -lm -lssl -lcrypto -lva -latomic -lX11
